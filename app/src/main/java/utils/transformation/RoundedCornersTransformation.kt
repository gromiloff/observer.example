...
class RoundedCornersTransformation(private val mRadius: Int, private val mCornerType: CornerType) : StubTransformation() {
    ...
    override fun transform(pool: BitmapPool, inBitmap: Bitmap, outWidth: Int, outHeight: Int): Bitmap {
        ...
        paint.shader = BitmapShader(inBitmap, Shader.TileMode.CLAMP, Shader.TileMode.CLAMP)
